...
const styles = StyleSheet.create({
  ...
  welcomeText: { fontSize: 36, fontWeight: 'bold', color: '#3A3A3A', textAlign: 'center', textShadowColor: 'rgba(0, 0, 0, 0.1)', textShadowOffset: { width: -1, height: 1 }, textShadowRadius: 2 },
